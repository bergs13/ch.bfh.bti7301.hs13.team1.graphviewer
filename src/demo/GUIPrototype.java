...
public class GUIPrototype<V, E> extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		informationPanel2 = new ui.controls.InformationPanel();
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(GUIPrototype.class.getName())
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			@Override
			public void run() {
				new GUIPrototype(gr).setVisible(true);
			}
		});
	}
	...
	private ui.controls.InformationPanel informationPanel2;
